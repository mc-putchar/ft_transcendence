...
def update_player_match(match, player, score, win=False):
	...
	# If the win flag is True, initiate blockchain storage for the match result
	if win:
		logger.info(f"BLOCKCHAIN STORAGE WINNER {player}")
		try:
			...
			# Retrieve the opponent player_match object via the get_opponent() method
		...
		# Catch any exception during blockchain update and log the error
